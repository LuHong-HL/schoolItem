...
<div>
<!-- 列表 -->
  <a-table :columns="columns" :dataSource="userData" class="myTable" :rowKey="record=>record.id" :pagination="false">
    <!-- 性别渲染 -->
    ...
    <template slot="headLink" slot-scope="headLink">
      ...
      <a-modal v-model="visible" :footer="null" :closable="false" width="400px">
        <img :src="$baseURL+headLink" alt="图片加载失败" title="刘亦菲" />
      </a-modal>
    </template>
